  ...
  .group(() => {
    ...
    router
      .group(()=>{
        ...
        router.get('/:id',[FolderController, 'show']).as('folders.show')
        router.get('/:id/edit',[FolderController, 'edit']).as('folders.edit')
        router.put('/:id',[FolderController, 'update']).as('folders.update')
        router.delete('/:id',[FolderController, 'destroy']).as('folders.destroy')
      })
      .prefix('/folders')
